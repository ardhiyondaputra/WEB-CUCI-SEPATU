    ...
    <div class="wrapper">
        ...
        <div class="portfolio-gallery">
            <div class="portfolio-item">
                <img src="{{ asset('assets/image/bg.png') }}" alt="Before and After Cleaning">
            ...
            <div class="portfolio-item">
            <img src="{{ asset('assets/image/bg.png') }}"  alt="Before and After Restoration">
                <div class="portfolio-overlay">
            ...
            <div class="portfolio-item">
                <img src="{{ asset('assets/image/bg.png') }}" alt="Before and After Polishing">
                <div class="portfolio-overlay">
                    <h3>Polishing</h3>
            ...
            <div class="portfolio-item">
                <img src="{{ asset('assets/image/bg.png') }}" alt="Before and After Waterproofing">
                <div class="portfolio-overlay">
                    <h3>Waterproofing</h3>
