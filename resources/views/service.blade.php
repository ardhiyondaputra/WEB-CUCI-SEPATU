    ...
    <div class="service-section">
        <div class="service-cards">
            <div class="service-card">
                <img src="{{ asset('assets/image/bg3.jpeg') }}" alt="Fast Clean">
                <h3 class="tengah">FAST CLEAN</h3>
                <p class="deskripsi">Treatment ...</p>
                <a href="#" class="tbl-biru">Keterangan Layanan</a>
            </div>
            <div class="service-card">
                <img src="{{ asset('assets/image/bg4.jpeg') }}" alt="Deep Clean">
                <h3 class="tengah">DEEP CLEAN: Mediun</h3>
                <p class="deskripsi">Treatment ...</p>
                <a href="#" class="tbl-biru">Keterangan Layanan</a>
            </div>
            <div class="service-card">
                <img src="{{ asset('assets/image/bg3.jpeg') }}" alt="Fast Clean">
                <h3 class="tengah">DEEP CLEAN : Hard</h3>
                <p class="deskripsi">Treatment ...</p>
                <a href="#" class="tbl-biru">Keterangan Layanan</a>
            </div>
        </div>
